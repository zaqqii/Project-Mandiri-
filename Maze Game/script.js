    ...
    function defineMaze() {
        ...
        while (!isComp) {
            ...
            for (index = 0; index < dirs.length; index++) {
                ...
                var nx = pos.x + monDir[direction].x;
                var ny = pos.y + monDir[direction].y;
                ...
                if (nx >= 0 && nx < width && ny >= 0 && ny < height) {
                    ...
                    if (!mazeMap[ny][nx].visited) {
                        ...
                        mazeMap[nx][ny][monDir[direction].o] = true;
...
function Player(maze, c, _cellSize, onComplate, sprite = null) {
    ...
    function check(e) {
        var cell = map[cellCoord.x][cellCoord.y];
        moves++;
        switch (e.keyCode) {
            case 65:
            case 37:
...
window.onload = function() {
    let vieWidth = $("#view").width();
    let viewHeight= $("#view").height();
    if (viewHeight < viewWidth) {
        ctx.canvas.width = viewHeight - viewHeight / 100;
        ctx.canvas.height = viewHeight - viewHeight / 100;
    } else{
        ctx.canvas.width = vieWidth - vieWidth / 100;
        ctx.canvas.height = vieWidth - vieWidth / 100;
    }
}

var complateOne = false;
var complateTwo = false;
var isComplate = () =>{
    if (complateOne === true && complateTwo === true) {
    }
    console.log("Runs");
    setTimeout(function(){   
    }, 500);
